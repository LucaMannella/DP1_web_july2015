<?php	/** --- intro.php --- **/
	...
	{	# If I have a cookie it's impossible to enter in this "if"
		if( isset($_GET["ExistCookie"]) )	# If I have this GET and I don't have the cookie, the cookies are disabled!
            ...
            #TODO: cambiare il valore da ? a & per ottenere corretta gestione dei cookie
			header("Location: http://".$_SERVER["HTTP_HOST"].$_SERVER["REQUEST_URI"]."?ExistCookie=TestValue"); #check
			die();
		}
	}
